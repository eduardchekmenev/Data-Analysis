...
def process_multiple_folders(start_folder, end_folder, base_path,
    ...
    for folder in range(start_folder, end_folder + 1):
        ...
        for idx, peak in enumerate(peaks):
            ...
            height = signal[peak]
            integral = simps(signal[left_edge:right_edge+1], ppm_axis[left_edge:right_edge+1])
...
process_single_folder(folder=10, base_path=r"D:\WSU\Raw Data\Spinsolve-1.4T_13C\2025-02-20\250220-155516 7degCarbon-Cells (Pyr_Cells_006)", 
                      allowed_ppms=[178, 170, 160, 124], n_iter=2, L=1500, initial_k=4, T2_apod=10, phase_corr_angle=10)
# process_single_folder(folder=10, base_path=r"D:\WSU\Raw Data\Spinsolve-1.4T_13C\2025-02-06\250206-131739 7degCarbon-Cells (KIC_SLIC_002)", 
#                       allowed_ppms=[178, 171, 160, 124], n_iter=2, L=1500, initial_k=6, T2_apod=10, phase_corr_angle=10)
...
#     base_path = r"D:\WSU\Raw Data\Spinsolve-1.4T_13C\2025-02-20\250220-140649 7degCarbon-Cells (Pyr_Cells_005)"
#     # Full path (including CSV filename) where the integrated results should be saved.
#     output_csv = r"D:\WSU\2025-02 Pyruvate Cell paper\Data Analysis\integrated_data_pyr005-2.csv"

#     process_multiple_folders(start_folder=1, end_folder=150,
#                              base_path=base_path,
#                              n_threshold=2, initial_k=4, L=1250, T2_apod=10, phase_corr_angle=10,
#                              allowed_ppms=[178, 170, 160, 124],
#                              ppm_threshold=1, 
#                              target_length=65536, n_iter=2,
#                              target_peaks=[178, 171, 160, 124],
...
# if __name__ == '__main__':
#     # Base path where folder subdirectories (each containing fid.csv) reside.
#     base_path = r"D:\WSU\Raw Data\Spinsolve-1.4T_13C\2025-02-06\250206-131739 7degCarbon-Cells (KIC_SLIC_002)"
#     # Full path (including CSV filename) where the integrated results should be saved.
#     output_csv = r"D:\WSU\2025-02 Ketoleucine Cell paper\Data Analysis\integrated_data_kic002-2.csv"

#     process_multiple_folders(start_folder=1, end_folder=150,
#                              base_path=base_path,
#                              n_threshold=3, initial_k=6, L=1250, T2_apod=10, phase_corr_angle=10,
#                              allowed_ppms=[178, 171, 160, 124],
#                              ppm_threshold=1, 
#                              target_length=65536, n_iter=2,
#                              target_peaks=[178, 171, 160, 124],
#                              metabolite_names=["hydrate", "ketoleucine", "bicarbonate", "CO2"],
#                              tolerance=1,
#                              output_csv=output_csv,
#                              time_interval=3.5)
